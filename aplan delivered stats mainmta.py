...
directory1 = "E:/A-plan August 2020/"
directory2 = "E:/A-plan August 2020/A-Plan August Final Data/"

file1 = "Aplan_main_MTA_Delivery_jul272020.csv"
file2 = "decisionproductionMTA_aug20.csv"
...
print(b.shape)
b.to_csv(directory1 + "oempro_production_Delivery_stats_jul20.csv", index=True)