...
directory2 = "C:/Users/Peter/OneDrive - Email Switchboard Ltd/A-plan October/A-Plan October Final Data/"

file1 = "aplan290919_delivery.csv"
...
print(b.shape)
b.to_csv(directory1 + "oempro_production_Delivery_stats.csv", index=True)